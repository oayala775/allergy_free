...
class DatabaseHelper {
  ...
  Future<void> _insertInitialData(Database db) async {
    await db.rawInsert('''
      ...
      ('Mostaza', 'assets/images/avatar/1_Mostaza.png'),
      ('Nueces', 'assets/images/avatar/2_Nuez.png'),
      ('Chocolate', 'assets/images/avatar/3_Chocolate.png'),
      ('Tomate', 'assets/images/avatar/4_Tomate.png'),
      ('Manzana', 'assets/images/avatar/5_Manzana.png'),
      ('Canela', 'assets/images/avatar/6_Canela.png'),
      ('Huevo', 'assets/images/avatar/7_Huevo.png'),
      ('Trigo', 'assets/images/avatar/8_Trigo.png'),
      ('Leche', 'assets/images/avatar/9_Leche.png'),
      ('Cacahuate', 'assets/images/avatar/10_Cacahuate.png'),
      ('Aguacate', 'assets/images/avatar/11_Aguacate.png'),
      ('Camarón', 'assets/images/avatar/12_Camaron.png'),
      ('Almendra', 'assets/images/avatar/13_Almendra.png'),
      ('Pescado', 'assets/images/avatar/14_Pescado.png'),
      ('Fresa', 'assets/images/avatar/15_Fresa.png'),
      ('Naranja', 'assets/images/avatar/16_Naranja.png'),
      ('Langosta', 'assets/images/avatar/17_Langosta.png'),
      ('Pan', 'assets/images/avatar/18_Pan.png'),
      ('Apio', 'assets/images/avatar/19_Apio.png'),
      ('Soja', 'assets/images/avatar/20_Soja.png'),
      ('Pistache', 'assets/images/avatar/21_Pistache.png')
    ''');
